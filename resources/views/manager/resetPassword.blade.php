    ...
    <div class="container">
        <div id="main" class="panel panel-default">
            ...
            <div class="panel-body">
                <form action="{{ route('managerResetPassword') }}" method="post">
                    <div class="input-group">
                        <span class="input-group-addon">手机</span>
                        <input id="phoneInput" type="text" name="manager[phone]" class="form-control" value="{{ old('manager.phone') }}">
                    </div>
                    <div class="input-group">
                        <span class="input-group-addon">新密码</span>
                        <input type="text" name="manager[password]" class="form-control" value="{{ old('manager.password') }}">
                    </div>
                    <div class="input-group">
